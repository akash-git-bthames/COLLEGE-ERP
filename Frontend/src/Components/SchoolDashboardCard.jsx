...
function SchoolDashboardCard() {
  ...
  return (
    <div className='h-full w-full sm:border-2 border-[0.1px] border-slate-500 shadow-md hover:shadow-slate-400 dark:hover:shadow-slate-600 duration-200 rounded-md bg-slate-100 dark:bg-slate-700 text-slate-900 dark:text-slate-200'>
      <div className='h-[50%] lg:text-6xl font-bold md:text-5xl sm:text-4xl text-2xl  flex justify-center items-center ' style={{color:color}}>{classes}</div>
